            ...
            <div class="col-md-8 col-xl-8 middle-wrapper">
                <div class="row">
                    <div class="card-body">
                        ...
                        <h6 class="card-title">Admin Account Profile</h6>

                        <form method="POST" action="{{ route('admin.profile.save') }}" class="forms-sample"
